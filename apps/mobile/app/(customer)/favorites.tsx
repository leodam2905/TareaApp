      ...
      >
        {favorites.length === 0 ? (
          <View style={s.empty}>
            ...
            <TouchableOpacity style={s.browseBtn} onPress={() => router.push("/(customer)/browse" as any)}>
...
const s = StyleSheet.create({
  ...
  card:          { margin: 16, marginBottom: 0, backgroundColor: "#F1F5F9", borderRadius: 16, padding: 16, borderWidth: 1, borderColor: "#E2E8F0", gap: 10 },
  ...
  bio:           { color: "#64748B", fontSize: 13, lineHeight: 18 },
