      ...
      >
        {notifs.length === 0 ? (
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <View style={[s.dot, { backgroundColor: typeColor[n.type] ?? C.slate400 }]} />
            <View style={{ flex: 1 }}>
...
const s = StyleSheet.create({
  ...
  card:        { flexDirection: "row", alignItems: "flex-start", gap: 12, marginHorizontal: 16, marginBottom: 8, backgroundColor: "#1E293B", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  cardUnread:  { borderColor: "rgba(56,189,248,0.2)", backgroundColor: "#1a2d3d" },
  dot:         { width: 4, borderRadius: 2, height: "100%" as any, minHeight: 40, marginTop: 2 },
  notifTitle:  { color: C.white, fontWeight: "700", fontSize: 14 },
  notifBody:   { color: C.slate400, fontSize: 13, marginTop: 3, lineHeight: 18 },
  notifTime:   { color: C.slate500, fontSize: 11, marginTop: 6 },
