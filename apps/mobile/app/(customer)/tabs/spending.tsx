...
const s = StyleSheet.create({
  ...
  totalCard:     { margin: 16, backgroundColor: "#1E293B", borderRadius: 20, padding: 24, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  totalLabel:    { color: C.slate400, fontSize: 13, fontWeight: "600" },
  totalValue:    { color: C.emerald, fontSize: 48, fontWeight: "900", marginTop: 4 },
  totalSub:      { color: C.slate500, fontSize: 12, marginTop: 4 },
  card:          { margin: 16, marginTop: 0, backgroundColor: "#1E293B", borderRadius: 16, padding: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)", gap: 12 },
  cardTitle:     { color: C.white, fontWeight: "800", fontSize: 15, marginBottom: 4 },
  catRow:        { flexDirection: "row", alignItems: "center", gap: 10 },
  catEmoji:      { fontSize: 20, width: 28 },
  catHeader:     { flexDirection: "row", justifyContent: "space-between", marginBottom: 4 },
  catName:       { color: C.slate300, fontSize: 13, fontWeight: "600" },
  catAmount:     { color: C.white, fontSize: 13, fontWeight: "700" },
  ...
  monthLabel:    { color: C.slate400, fontSize: 12, width: 70 },
  monthBarBg:    { flex: 1, height: 8, backgroundColor: "rgba(255,255,255,0.08)", borderRadius: 4 },
  monthBarFill:  { height: 8, backgroundColor: C.emerald, borderRadius: 4 },
  monthAmount:   { color: C.white, fontSize: 12, fontWeight: "700", width: 44, textAlign: "right" },
  txRow:         { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 4 },
  txEmoji:       { fontSize: 20, width: 28 },
  txTitle:       { color: C.white, fontWeight: "600", fontSize: 13 },
  txMeta:        { color: C.slate500, fontSize: 11, marginTop: 2 },
  txAmount:      { color: C.red, fontWeight: "700", fontSize: 14 },
  empty:         { alignItems: "center", paddingTop: 40, gap: 12 },
  emptyEmoji:    { fontSize: 48 },
  emptyText:     { color: C.slate400, fontSize: 15 },
});
