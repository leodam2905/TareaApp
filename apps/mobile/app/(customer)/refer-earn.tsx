...
const s = StyleSheet.create({
  ...
  heroTitle:     { color: "#0F172A", fontSize: 28, fontWeight: "900" },
  heroSub:       { color: "#64748B", fontSize: 14, textAlign: "center", lineHeight: 20, paddingHorizontal: 16 },
  statsRow:      { flexDirection: "row", gap: 12, marginBottom: 16 },
  statCard:      { flex: 1, backgroundColor: "#F1F5F9", borderRadius: 16, padding: 18, alignItems: "center", borderWidth: 1, borderColor: "#E2E8F0" },
  statValue:     { color: C.sky, fontSize: 32, fontWeight: "900" },
  statLabel:     { color: "#64748B", fontSize: 12, marginTop: 4 },
  codeCard:      { backgroundColor: "#F1F5F9", borderRadius: 20, padding: 20, gap: 14, borderWidth: 1, borderColor: "#E2E8F0", marginBottom: 16 },
  codeLabel:     { color: "#64748B", fontSize: 13, fontWeight: "700" },
  ...
  actionBtn:     { flex: 1, backgroundColor: "#E2E8F0", borderRadius: 12, paddingVertical: 12, alignItems: "center" },
  ...
  howCard:       { backgroundColor: "#F1F5F9", borderRadius: 20, padding: 20, gap: 14, borderWidth: 1, borderColor: "#E2E8F0" },
  howTitle:      { color: "#0F172A", fontWeight: "800", fontSize: 16 },
  ...
  howText:       { color: "#334155", fontSize: 14, flex: 1, lineHeight: 20 },
});
