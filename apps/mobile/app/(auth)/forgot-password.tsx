...
const s = StyleSheet.create({
  ...
  info:        { color: C.slate400, fontSize: 14, lineHeight: 20, marginBottom: 16 },
  ...
  sentTitle:   { color: C.white, fontSize: 20, fontWeight: "800", textAlign: "center", marginBottom: 10 },
  sentText:    { color: C.slate400, fontSize: 14, lineHeight: 21, textAlign: "center" },
  sentBold:    { color: C.white, fontWeight: "700" },
});
