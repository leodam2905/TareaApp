...
const s = StyleSheet.create({
  ...
  scroll:      { flex: 1 },
  dayCard:     { backgroundColor: C.surface, borderRadius: 16, marginBottom: 8, borderWidth: 1, borderColor: C.line, overflow: "hidden" },
  dayCardOn:   { borderColor: "rgba(56,189,248,0.3)" },
  dayRow:      { flexDirection: "row", alignItems: "center", padding: 14, gap: 12 },
  check:       { width: 22, height: 22, borderRadius: 11, borderWidth: 2, borderColor: C.line, alignItems: "center", justifyContent: "center" },
  checkOn:     { backgroundColor: C.sky, borderColor: C.sky },
  checkMark:   { color: C.ink, fontWeight: "900", fontSize: 12 },
  dayName:     { color: C.textMuted, fontWeight: "700", fontSize: 15, width: 36 },
  dayNameOn:   { color: C.sky },
  dayHours:    { flex: 1, color: C.textMuted, fontSize: 12 },
  editBtn:     { padding: 4 },
  editBtnText: { color: C.textMuted, fontSize: 12 },
  hourPickers: { flexDirection: "row", borderTopWidth: 1, borderTopColor: C.line, padding: 14, gap: 16, justifyContent: "center" },
  picker:      { alignItems: "center", gap: 6, flex: 1 },
  pickerLabel: { color: C.textMuted, fontSize: 11, fontWeight: "600" },
  pickerBtn:   { padding: 8 },
  pickerArrow: { color: C.sky, fontSize: 16, fontWeight: "700" },
  pickerValue: { color: C.text, fontWeight: "700", fontSize: 14 },
