...
const s = StyleSheet.create({
  ...
  name:          { color: C.text, fontSize: 26, fontWeight: "900" },
  ...
  progressTrack: { height: 6, backgroundColor: C.surface, borderRadius: 3, marginBottom: 16 },
  progressFill:  { height: 6, backgroundColor: C.sky, borderRadius: 3 },
  stepsGrid:     { gap: 8 },
  stepPill:      { flexDirection: "row", alignItems: "center", gap: 10, padding: 12, backgroundColor: C.surface, borderRadius: 12, borderWidth: 1, borderColor: C.line },
  ...
  stepLabel:     { color: C.text, fontSize: 14, fontWeight: "600", flex: 1 },
  ...
  statCard:      { flex: 1, backgroundColor: C.surface, borderRadius: 16, padding: 14, alignItems: "center", borderWidth: 1, borderColor: C.line },
  statValue:     { fontSize: 20, fontWeight: "900" },
  statLabel:     { color: C.textMuted, fontSize: 11, marginTop: 2 },
  sectionTitle:  { color: C.text, fontSize: 17, fontWeight: "800", paddingHorizontal: 16, marginTop: 20, marginBottom: 10 },
  actionsGrid:   { flexDirection: "row", flexWrap: "wrap", gap: 10, paddingHorizontal: 16, paddingBottom: 32 },
  actionCard:    { width: "47%", backgroundColor: C.surface, borderRadius: 16, padding: 18, alignItems: "center", gap: 8, borderWidth: 1, borderColor: C.line },
  actionEmoji:   { fontSize: 28 },
  actionLabel:   { color: C.text, fontSize: 13, fontWeight: "700", textAlign: "center" },
});
