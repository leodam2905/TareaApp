...
const s = StyleSheet.create({
  ...
  filterBtn:       { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, backgroundColor: "#1E293B", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  ...
  card:            { marginHorizontal: 16, marginBottom: 10, backgroundColor: "#1E293B", borderRadius: 16, padding: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.07)" },
  ...
  customerName:    { color: C.slate400, fontSize: 12, marginTop: 1 },
