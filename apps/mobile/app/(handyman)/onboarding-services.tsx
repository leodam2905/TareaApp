...
const s = StyleSheet.create({
  ...
  scroll:         { flex: 1 },
  serviceCard:    { backgroundColor: "#1E293B", borderRadius: 16, marginBottom: 8, borderWidth: 1, borderColor: "rgba(255,255,255,0.07)", overflow: "hidden" },
  serviceCardOn:  { borderColor: C.sky },
  serviceRow:     { flexDirection: "row", alignItems: "center", padding: 14, gap: 12 },
  serviceEmoji:   { fontSize: 24 },
  serviceInfo:    { flex: 1 },
  serviceLabel:   { color: C.white, fontWeight: "700", fontSize: 15 },
  ...
  detailField:    { flex: 1 },
  detailLabel:    { color: C.slate400, fontSize: 11, fontWeight: "600", marginBottom: 4 },
  detailInput:    { backgroundColor: "rgba(255,255,255,0.07)", borderWidth: 1, borderColor: "rgba(255,255,255,0.1)", borderRadius: 10, padding: 8, color: C.white, fontSize: 13, textAlign: "center" },
