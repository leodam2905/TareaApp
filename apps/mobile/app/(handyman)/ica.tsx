...
const s = StyleSheet.create({
  ...
  doc:             { flex: 1, backgroundColor: C.surface, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: C.line },
  docHeading:      { color: C.text, fontWeight: "900", fontSize: 16, textAlign: "center", marginBottom: 4 },
  ...
  sectionBody:     { color: C.textMuted, fontSize: 13, lineHeight: 19 },
  signature:       { borderTopWidth: 1, borderTopColor: C.line, paddingTop: 16, marginTop: 8, alignItems: "center", gap: 4 },
  sigText:         { color: C.slate500, fontSize: 11 },
  sigName:         { color: C.text, fontWeight: "700", fontSize: 13 },
  sigFooter:       { color: C.slate600, fontSize: 10, marginTop: 4 },
  checkRow:        { flexDirection: "row", gap: 12, alignItems: "flex-start", backgroundColor: C.surface, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: C.line },
