...
const s = StyleSheet.create({
  ...
  card:          { margin: 16, backgroundColor: C.surface, borderRadius: 16, padding: 16, borderWidth: 1, borderColor: C.line },
  serviceTitle:  { color: C.text, fontSize: 18, fontWeight: "900", marginBottom: 2 },
  serviceCat:    { color: C.sky, fontSize: 12, marginBottom: 12 },
  divider:       { height: 1, backgroundColor: C.surface, marginVertical: 10 },
  unpaid:        { color: C.amber, fontSize: 12, marginTop: 8 },
  notes:         { color: C.textMuted, fontSize: 13, lineHeight: 19 },
  ...
  timerValue:    { color: C.text, fontSize: 52, fontWeight: "900", letterSpacing: 4, fontVariant: ["tabular-nums"] },
  ...
  phaseRow:      { flexDirection: "row", alignItems: "flex-start", gap: 12, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: C.line },
  ...
  phaseIconText: { color: C.text, fontSize: 13, fontWeight: "700" },
  phaseTitle:    { color: C.text, fontWeight: "600", fontSize: 14 },
  phaseMeta:     { color: C.slate500, fontSize: 11, marginTop: 2 },
  phaseForm:     { backgroundColor: C.surface, borderRadius: 14, padding: 14, gap: 10, borderWidth: 1, borderColor: C.line },
  phaseInput:    { color: C.text, fontSize: 14, borderBottomWidth: 1, borderBottomColor: C.line, paddingBottom: 8 },
  phaseFormBtns: { flexDirection: "row", gap: 8 },
  phaseCancelBtn:{ flex: 1, paddingVertical: 10, alignItems: "center", borderRadius: 10, borderWidth: 1, borderColor: C.line },
  phaseCancelText:{ color: C.textMuted, fontWeight: "600" },
  ...
  acceptBtnText: { color: C.text, fontWeight: "900", fontSize: 15 },
  ...
  startBtnText:  { color: C.text, fontWeight: "900", fontSize: 16 },
  completeBtn:   { backgroundColor: C.emerald, borderRadius: 14, paddingVertical: 16, alignItems: "center" },
  completeBtnText:{ color: C.text, fontWeight: "900", fontSize: 16 },
  ...
  completedMeta: { color: C.textMuted, fontSize: 13 },
