...
const s = StyleSheet.create({
  ...
  header:      { flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 16, borderBottomWidth: 1, borderBottomColor: C.line },
  ...
  msgMine:     { color: C.ink },
  msgTheirs:   { color: C.text },
  time:        { fontSize: 10, marginTop: 4, opacity: 0.6, alignSelf: "flex-end", color: C.ink },
  inputRow:    { flexDirection: "row", alignItems: "flex-end", padding: 12, gap: 10, borderTopWidth: 1, borderTopColor: C.line },
  input:       { flex: 1, backgroundColor: C.surface, borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, color: C.text, fontSize: 15, maxHeight: 120, borderWidth: 1, borderColor: C.line },
