...
class ServiceCat {
  ...
  // `icon` matches the customer dashboard's outlined-icon style.
  final String name, api, nameKey;
  final Color color;
  final IconData icon;
  const ServiceCat(this.name, this.api, this.color, this.nameKey, this.icon);
}
...
const kServiceCats = [
  ...
  ServiceCat('HVAC', 'HVAC', Color(0xFF22D3EE), 'categories.hvac', Icons.ac_unit_outlined),
  ...
  ServiceCat('General', 'GENERAL', Color(0xFF94A3B8), 'categories.general', Icons.build_outlined),
];
