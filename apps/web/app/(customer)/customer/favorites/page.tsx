      ...
      {loading ? (
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {favorites.map(({ id, handyman: h }) => (
            <div key={id} className="bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-tarea-sky/20 transition-colors">
              ...
              <div className="flex gap-2 mt-4 pt-4 border-t border-white/10">
                <Link
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 bg-tarea-sky text-tarea-ink font-bold text-sm py-2.5 rounded-xl hover:bg-sky-300 transition-colors"
                >
