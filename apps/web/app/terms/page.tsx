      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 prose-custom">
          ...
          <Section title="5. Bookings and Payments">
            ...
            <p>Customers pay the Pro's service price plus a <strong>10% platform service fee</strong>. Pros receive 90% of the agreed service price. Payouts are processed via Stripe Connect and subject to Stripe's Terms of Service.</p>
