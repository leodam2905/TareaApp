      ...
      <section className="hero shell" aria-labelledby="hero-title">
        <div className="heroCopy">
          ...
          <div className="heroActions">
            <a className="button buttonCoral" href="#diagnosis">Diagnose my issue <Arrow /></a>
            <a className="button buttonLight" href="#services">Browse services</a>
          </div>
      ...
      <section className="diagnosisSection" id="diagnosis" aria-labelledby="diagnosis-title">
        <div className="shell diagnosisLayout">
          <div className="diagnosisCopy">
            ...
            <a className="button buttonCoral" href="#choice">Start a diagnosis <Arrow /></a>
          </div>
