    ...
    html: `
      <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:32px 24px">
        ...
        <table style="width:100%;border-collapse:collapse">
          <tr><td style="padding:8px 0;color:#64748B;width:100px">From</td><td style="padding:8px 0;color:#0F172A;font-weight:600">${name} &lt;${email}&gt;</td></tr>
          <tr><td style="padding:8px 0;color:#64748B">Role</td><td style="padding:8px 0;color:#0F172A">${role || "Not specified"}</td></tr>
          <tr><td style="padding:8px 0;color:#64748B">Subject</td><td style="padding:8px 0;color:#0F172A">${subject}</td></tr>
        </table>
        <div style="margin-top:16px;padding:16px;background:#F8FAFC;border-radius:8px;color:#334155;white-space:pre-wrap">${message}</div>
  ...
  await sendEmail({
    ...
    html: `
      <div style="font-family:Inter,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px">
        ...
        <h1 style="font-size:22px;font-weight:700;color:#0F172A;margin:0 0 8px">We got your message, ${name.split(" ")[0]}!</h1>
        ...
        <div style="padding:16px;background:#F8FAFC;border-radius:8px;color:#334155;border-left:4px solid #38BDF8;margin-bottom:24px">
          <p style="margin:0 0 4px;font-weight:600;color:#0F172A">${subject}</p>
